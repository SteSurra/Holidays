...
hakone|hakone-yuryo|Hakone Yuryo|箱根湯寮|wellness|Tonosawa, sopra Hakone-Yumoto|1,5-2 ore|Le vasche private nei fine settimana finiscono presto: controlla la disponibilità la mattina stessa, non all'arrivo. La navetta parte dal piazzale della stazione di Hakone-Yumoto, e dal 2025 i tatuaggi non sono più motivo di esclusione.|Stabilimento termale a Tonosawa, appena sopra Hakone-Yumoto: vasche comuni e una serie di vasche private che si prenotano, a tre minuti di navetta gratuita dalla stazione.|Hakone Yuryo Hakone|35.23383|139.09583||
hakone|vecchia-tokaido-amazake|La vecchia Tokaido e Amazake-chaya|旧東海道石畳・甘酒茶屋|sports|Da Moto-Hakone verso Hatajuku|1,5-2 ore|Falla in discesa da Moto-Hakone e non tornare indietro a piedi: davanti alla casa da tè c'è la fermata del bus della Hakone Tozan. Scarpe con suola vera, le pietre lisce bagnate scivolano.|Un tratto della vecchia Tokaido ancora lastricato di pietre, nel bosco fra Moto-Hakone e Hatajuku, che finisce alla casa da tè dove servono amazake da quattrocento anni.|旧東海道石畳・甘酒茶屋|35.20218|139.04894||
`).map(function (item) {
    item.id = "experience-" + item.city + "-" + item.slug;
    item.type = "experience";
    item.lat = item.lat ? Number(item.lat) : null;
