...
|---|---|---:|---:|---|
| `minimo` | Shell + facility layers | 3785669 | 3.61 MiB | Shell files from sw.js SHELL + facilities-ampio.json.gz |
| `medio` | Shell + curated photos @960 + facility layers | 136429427 | 130 MiB | 609/609 photos ok + facilities |
| `ampio_z14` | Medio + Ampio city bubbles z≤14 | 212860385 | 203 MiB | region=ampio-tappe.geojson |
| `ampio_z15` | Medio + Ampio city bubbles z≤15 | 340580586 | 325 MiB | region=ampio-tappe.geojson |
| `max_z14` | Medio + Japan bbox z≤14 | 1389489768 | 1.29 GiB | bbox=129.0,30.9,145.9,45.6 |
| `max_z15` | Medio + Japan bbox z≤15 | 2866186100 | 2.67 GiB | bbox=129.0,30.9,145.9,45.6 |
...
| Facilities (trip bubbles) | 131583 | 129 KiB | 14683 points; build with build-offline-facility-pack.mjs |
